<div class="button-add-student">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Adicionar estudante</button>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form method="POST" action="addstudent.php" enctype="multipart/form-data">
                                  ...
                                  <div class="">
                                    <label for="recipient-name" class="col-form-label">Número de matrícula:</label>
                                    <input type="text" class="form-control" id="recipient-name" name="EnrollNumber">
                                  </div>
                                  <div class="">
                                    <label for="recipient-name" class="col-form-label">Data de matrícula:</label>
